...
function buildModal2(categoria) {
  ...
  return {
    ...
    blocks: [
      ...
      { type: 'input', block_id: 'id_ticket', optional: true, element: { type: 'plain_text_input', action_id: 'value' }, label: { type: 'plain_text', text: 'ID Ticket (site ExitLag)' } },
      ...
      { type: 'input', block_id: 'link_private', optional: true, element: { type: 'plain_text_input', action_id: 'value', placeholder: { type: 'plain_text', text: 'https://... (somente Private Server)' } }, label: { type: 'plain_text', text: 'Link servidor private' } },
